...
<c:forEach items="${Personnes}" var="persone">
		<div class="produit">
			<a href="user_detail
			?url=${persone.url }
			&nom=${persone.nom }
			&prenom=${persone.prenom }
			&dateDeNaissance=${persone.dateDeNaissance}
			&numeroTelephone=${persone.numeroTelephone}
			&mail=${persone.mail}
			&numeroRue=${persone.numeroRue}
			&ville=${persone.ville}
