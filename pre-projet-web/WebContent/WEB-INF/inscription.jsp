<%@page import="fr.goffa.utilisateur.Personne"%>
...
<body>
 ...
 <%
 Personne jack=(Personne) request.getAttribute("jack-infos");
 %>
...
<div>
    ...
    <form action="inscriptionOk" method="post" style="width: 250px; margin: auto" name="inscription-forms">
        <fieldset>
            ...
            <input type="nom" name="nom" size="20"
                   maxlength="40" placeholder="nom" value=<%=jack.getNom()%> id="nom" />

            <label for="prenom">Prénom :</label>
            <input type="prenom" name="prenom" size="20"
                   maxlength="40" placeholder="prenom" value=<%=jack.getPrenom() %> id="prenom" />

            <label for="date-naissance">Date de naissance :</label>
            <input type="date" name="date-naissance" placeholder="date-naissance"  value=<%=jack.getDateDeNaissance() %> id="date-naissance"/>

            <label for="adresse">N° et rue :</label>
            <input type="text" name="adresse" placeholder="rue" value=<%=jack.getNumeroRue() %> id="adresse" />

            <label for="ville">Ville :</label>
            <input type="text" name="ville" size="20"
                   maxlength="40" placeholder="ville"  value=<%=jack.getVille() %> id="ville"/>
            ...
            <input type="tel" name="phone"
                   maxlength="10" placeholder="phone" value=<%=jack.getNumeroTelephone() %> id="phone"/>
            <label for="email">Votre email :</label>
            <input type="text"   name="email"
                   maxlength="10" placeholder="email" value=<%= jack.getMail() %> id="email" />
        ...
        <div>
            ...
            <button type="button" onclick="validerFormulaire()">Envoyer</button>
